...
<template>
  <div>
    ...
    <!-- File selector -->
    <div class="p-4 pl-16">
      <img class="rounded-2xl border" :class="twitterBorderColor" v-if="inputImageUrl" :src="inputImageUrl" alt="">
    ...
    <div class="flex p-2 pl-14 items-center">
      ...
      <div class="ml-auto">
        <UIButton @click="handleFormSubmit" size="sm" :disabled="isDisabled">
          <strong>Tweet</strong>
        </UIButton>
      </div>
    </div>
